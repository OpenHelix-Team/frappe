...
python -m data.compute_dataset_stat_hdf5 --task_name $CONFIG_NAME --wm_horizon 8

accelerate launch --main_process_port=29501 --multi_gpu --num_processes=2 main_post_train.py \
